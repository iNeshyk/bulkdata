...
module.exports = {
  ...
  t010_Bulkdata: ()=>{
    ...
    return ` EntryGUID nvarchar(36)
           ...
           ,Posted bit
           ,LustTruckEventID nvarchar(50)
           ,LustTruckEventName nvarchar(100)
           ,Departure bit
        ...
        t010_Bulkdata_fields: () =>{
          ...
          res.push('Posted');
          res.push('LustTruckEventID');
          res.push('LustTruckEventName');
          res.push('Departure');
        ...
        t115_Track: ()=>{
          return `TrackID	nvarchar(56),
                  TrackDate	datetime,
                  DriverID	nvarchar(20),
                  TruckID	nvarchar(20),
                  TruckID2	nvarchar(20),
                  ItemID	nvarchar(20),
                  ItemName	nvarchar(200),
                  Netto	nvarchar(20),
                  SenderName	nvarchar(400),
                  DestinationName	nvarchar(400)
                  `;
               },
        t115_Track_fields: ()=> {
          let res = [];
